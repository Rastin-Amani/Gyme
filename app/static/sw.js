    ...
    event.respondWith(
        fetch(request)
            ...
            .catch(async () => {
                ...
                return new Response(
                    '<!doctype html><html dir="ltr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Offline</title></head><body style="font-family:system-ui;background:#1d232a;color:#fff;min-height:100dvh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:2rem"><h1>You are offline</h1><p style="color:#9ca3af;margin:1rem 0 2rem">The page you are trying to open has not been saved yet.</p><button onclick="location.reload()" style="padding:.75rem 2rem;background:#2a7eff;color:#fff;border:none;border-radius:999px;font-weight:600;cursor:pointer">Try again</button></body></html>',
